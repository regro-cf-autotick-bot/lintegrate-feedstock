...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lintegrate-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lintegrate-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi global install lintegrate
```
...
It is possible to list all of the versions of `lintegrate` available on your platform:
...
```
pixi search lintegrate --channel conda-forge
```
